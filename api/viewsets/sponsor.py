...
# Serializer
from api.serializers import SponsorBaseSerializer, SponsorReadSerializer, SponsorSaveSerializer


class SponsorViewSet(viewsets.ModelViewSet):
    serializer_class = SponsorReadSerializer
    ...
    def get_serializer_class(self):
        ...
        if async_options:
            return SponsorBaseSerializer
        if self.action == 'list' or self.action == 'retrieve':
            return SponsorReadSerializer
        else:
            return SponsorSaveSerializer
