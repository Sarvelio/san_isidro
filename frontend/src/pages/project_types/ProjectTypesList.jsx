...
export default function ProjectTypesList() {
  const { data, page, getData } = useList("project_types");
  const { deleteData } = useDelete("project_types");
  ...
  return (
    <>
      <div className="flex mb-2 sm:mb-0">
        <h1 className="text-title">Tipos de proyecto</h1>
      </div>
